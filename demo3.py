# Form implementation generated from reading ui file 'D:\BitBreaker\demo3.ui'
#
...
"color: rgb(249, 230, 16);")
        ...
        self.frame = QtWidgets.QFrame(parent=self.centralwidget)
        self.frame.setGeometry(QtCore.QRect(50, 180, 291, 101))
        self.frame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame.setObjectName("frame")
        self.label2_2 = QtWidgets.QLabel(parent=self.frame)
        self.label2_2.setGeometry(QtCore.QRect(40, 30, 201, 41))
        font = QtGui.QFont()
        font.setFamily("ArcadeClassic")
